...
<div class="card">
                <div class="card-header">
                      ...
                      <div class="d-flex justify-content-end">
                        <div class="input-group input-group-merge" style="margin-right: 20px">
                  ...
                  <table class="table">
                    ...
                    <tbody class="table-border-bottom-0">
                      ...
                      <tr>
                            ...
                            <td><button class="btn btn-primary">Onboard</button></td>
                      ...
                      <tr>
                            ...
                            <td>fardin@gmail.com</td>
                            <td>7/9/25</td>
                            <td><span class="badge bg-label-success me-1">On Process</span></td>
