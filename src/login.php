            ...
            <div class="card-body">
              ...
              <div class="app-brand justify-content-center">
                <a href="#" class="app-brand-link gap-2">
                  ...
                  <span class="app-brand-text demo text-body fw-bolder">Easy CRM</span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Welcome to Easy CRM! 👋</h4>
    ...
    <footer class="content-footer footer bg-footer-theme">
              <div class="container-xxl text-center py-3">
                <div class="mb-2 mb-md-0">
                  ...
                  | Developed by
                  <a href="https://easytechx.com" target="_blank" class="footer-link fw-bolder">Easy Tech Solutions</a>
                </div>
